    ...
    <div id="left_side">
        <form action="" method="post">
            <table>
                <tr>
                    <td>
                        <input type="submit" name="search_student" value="Delete a Site">
                    </td>
                </tr>
                </tr>
            </table>
    ...
    <div id="right_side"><br><br>
        <div id="demo">
            ...
            if (isset($_POST['search_by_roll_num_for_search'])) {
                $query = "DELETE FROM `site` WHERE `site`.`site_ID` = '$_POST[roll_no]'";
                $query2 = "DELETE FROM `relation_tab` WHERE `relation_tab`.`Site_ID` = '$_POST[roll_no]'";
                $query3 = "DELETE FROM `site_img` WHERE `site_img`.`site_id` = '$_POST[roll_no]'";
                if ($con->query($query) == true && $con->query($query2) == true && $con->query($query3) == true) {
                    echo '<h1>Deleted!</h1>';
                } else {
