...
if (isset($_SESSION['uname'])) {
    ...
    $dat = date('y-m-d');
    $dat=$y.$dat;
    $query = "SELECT * from users,relation_tab,site WHERE users.Customer_ID = relation_tab.Customer_ID AND relation_tab.Site_ID = site.site_ID AND (site.Hand_over_date < '$dat')";
...
<body>
    ...
    <table align="center" border="1px" style="width:800px; line-height:40px;background-color: whitesmoke; text-align: center; padding:20px;margin:auto;">
        <tr>
            <th colspan="30">
                <h2>All Inactive Client Records</h2>
            </th>
        </tr>
        <th> ID </th>
        <th> Client Name </th>
